...
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HIEGHT )), 90)
RED_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'spaceship_red.png'))
RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(RED_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HIEGHT )), 270)
...
def main():
	yellow = pygame.Rect(100, 300, SPACESHIP_WIDTH, SPACESHIP_HIEGHT)
	red = pygame.Rect(700, 300, SPACESHIP_WIDTH, SPACESHIP_HIEGHT)
	run = True
